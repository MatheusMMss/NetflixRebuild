package com.netflixrebuild.util;
...
import com.netflixrebuild.model.MovieDetail;
...
public class MovieDetailTask extends AsyncTask<String, Void, MovieDetail> {
    ...
    protected MovieDetail doInBackground(String... params) {
        ...
        try {
            ...
            urlConnection.setReadTimeout(2000); //tempo de leitura em 2s (está em milissegundos)
            urlConnection.setConnectTimeout(2000); //tempo de espera pra mensagem de erro
